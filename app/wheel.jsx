  ...
  return (
    <div style={{ position: 'relative', padding: '2px' }}>
      ...
      <div style={{ ...{ ...{
            ...
            }, borderRadius: "0px", width: "416px", height: cta ? "auto" : "204px", minHeight: cta ? 0 : 188, gap: "0px" }, height: theme.cardHeight || (cta ? "auto" : theme.bigWheels ? "196px" : "160px"), minHeight: theme.cardMinHeight != null ? theme.cardMinHeight : (cta ? 0 : 188), alignItems: "center", padding: theme.cardPadding || "24px 16px 16px", margin: "8px 0px 24px", width: "416px" }}>
